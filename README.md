...
Functionality: **_What happens if we use multiple to(...) statements instead of proper EIP patterns?_**
...
Git clone the xbc_NonEIPMultipleTo project into your workspace:

_from your bash shell:_

```bash
cd yourworkspacedirectory
git clone https://github.com/jammazwan/xbc_NonEIPMultipleTo.git
cd xbc_NonEIPMultipleTo
mvn install -DskipTests

```

You man now import xbc_NonEIPMultipleTo into your IDE.
...
_Run XbcTest, should create 3 files, and satisfy 2 mocks. See NOTES.md_
